...
public class Configs
{
    ...
    private static void loadConfigs(Configuration conf)
    {
        ...
        prop.comment = "Enables verbose logging for debug purposes";
        ...
        prop.comment = "Enables tracking dimension load counts, by storing the counts in a file in worlddir/worldprimer/dim_loads.nbt";
        ...
        prop.comment = "Enables early world creation commands, which are executed before any dimensions\n" +
        ...
        prop.comment = "Enables early world loading commands, which are executed once at each server start,\n"+
        ...
        prop.comment = "Enables late world creation commands, which are executed after the overworld spawn chunks have been generated";
        ...
        prop.comment = "Enables late world loading commands, which are executed once at each server start,\n"+
        ...
        prop.comment = "Commands to run when a dimension gets loaded.\n" +
        ...
        prop.comment = "Commands to run on initial world creation, before the spawn chunks have been generated or loaded.\n" +
        ...
        prop.comment = "Commands to run every time the world gets loaded.\n" +
        ...
        prop.comment = "Commands to run on initial world creation, after the spawn chunks have been generated and loaded.";
